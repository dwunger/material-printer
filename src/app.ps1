...
$STARTUP_LOGMSG = "- Added Wash buffer SDS label,`n  send-out stickers, and tired Pepe`n- Added Advanced Help option [?]`n- Simple Atari Frog Bog port to`n  WinForms [g]`n- Added BB Printers`n- Added BB phenotyping instructions`n- Added Downtime Barcode printer"
