...
$STARTUP_LOGMSG = "- Added Downtime Barcode printer`n- Expiration bug fix for CS2500 materials`n- SP Thaw&Open $RIGHT_ARROW Thawed`n- Moved misc controls to [Help]`n- Hidden exploding duck animation"
